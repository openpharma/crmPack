...
#SafetyWindowConst(patientGap = c(7,3),
#                                    patientFollow = 7,  this is the minimal required condition for all patienst in the cohort
#                                    patientFollowMin = 14) min is condition for at least one patient
