...
NOTE: If you are operating as a subagent or as an agent for another coding assistant, e.g. you are an agent for Codex, do not include next steps and only output your review.
