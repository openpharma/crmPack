# Internal Helper Functions for Validation of [`Stopping`](https://docs.crmpack.org/reference/Stopping-class.md) Objects

**\[stable\]**

These functions are only used internally to validate the format of an
input [`Stopping`](https://docs.crmpack.org/reference/Stopping-class.md)
