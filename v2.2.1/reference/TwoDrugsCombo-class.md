...
#>       }
#>     }
#> <bytecode: 0x561d98aae160>
#> <environment: 0x561da3cea550>
#> 
#> Slot "priormodel":
#> function() {
...
#>       alpha1 <- exp(theta[2])
#>     }
#> <bytecode: 0x561d9936a7d0>
#> <environment: 0x561da3cea320>
#> 
#> Slot "modelspecs":
#> function(from_prior) {
...
#>       ms
#>     }
#> <bytecode: 0x561d91bcdbe8>
#> <environment: 0x561da3ceb6d0>
#> 
#> Slot "init":
#> function() {
#>         c(
