  ...
  def =
    function(object, nsim = 1L, seed = NULL,
      ...
      ret <- PseudoSimulations(
        ...
        doses = recommendedDoses,
        fit = fitList,
        final_tdtarget_during_trial_estimates = TDtargetDuringTrialList,
        final_tdtarget_end_of_trial_estimates = TDtargetEndOfTrialList,
        final_tdtarget_during_trial_at_dose_grid = TDtargetDuringTrialDoseGridList,
        final_tdtarget_end_of_trial_at_dose_grid = TDtargetEndOfTrialDoseGridList,
        final_cis = CIList,
