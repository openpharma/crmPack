...
v_simulations <- function(object) {
  ...
  v$check(
    assert_named(object@additional_stats),
    "additional_stats must contained named list of quantile functions."
  )

  v$check(
    assert_numeric(object@additional_stats),
    "additional_stats must return named numeric vector."
  )

  v$result()
}

#' @describeIn v_general_simulations validates that the [`DualSimulations`] object and capture the dose-biomarker `fits`, and the
...
#' @describeIn v_general_simulations validates that the [`PseudoSimulations`] object
...
#' @describeIn v_general_simulations validates that the [`PseudoDualSimulations`] object
...
#' @describeIn v_general_simulations validates that the [`PseudoDualFlexiSimulations`] object
