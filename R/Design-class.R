...
#'
#' @slot model (`GeneralModel`)\cr the model to use, see in particular [DALogisticLogNormal],
#' [TITELogisticLogNormal] and [TITELogisticLogNormalSub] which make use of the time-to-DLT data.
