...
We can see from the patient IDs, which are assigned sequentially in time, when the backfill patients were recruited (those with a "B" mark on the left of the points). For example, we see that the highest dose which was backfilled is 15, after which the maximum of 12 backfill patients was reached.
