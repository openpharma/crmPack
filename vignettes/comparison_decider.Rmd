...
analytic Cholesky factor for each correlated pair. This helps to increase the 
effective sample size (ESS) a lot for the arm-level and hypermean parameters, which mixed
...
}
{
    ...
    mu_eta_z ~ dnorm(0, 1)
    mu_eta <- mu_eta_mean + mu_eta_sd * mu_eta_z
