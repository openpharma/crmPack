...
emptydata <- DataTITE(doseGrid=seq(from=2, to=50, by=2),Tmax=Tmax_,weightMethod = "adaptive")
...
todo: we need to show here how to get the plots from the manuscript
Jiawen: I have 2 seperate R files for all the plots in the manuscript. the plots will use multiple simulation results though. 
