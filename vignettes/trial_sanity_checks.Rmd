...
```{r minimal-informative, error=TRUE}
...
This new design allows us to escalate over the full extent of the dose grid before the futility stopping rule kicks in.  Further refinement of the prior model may remove the need for additional cohorts before escalation above 25 mg.  We leave that as an exercise for the reader.
