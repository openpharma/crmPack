...
# Rule for cohort of size 1 until no DLT were observed cohort of size 3 as soon
# as 1 DLT is observed.
my_size2 <- CohortSizeDLT(dlt_intervals = c(0, 1), cohort_size = c(1, 3))

# Cohort size rules of class 'CohortSizeMax' which will then be
