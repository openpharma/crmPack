...
## specifying the shape (a) and the rate (b) parameters for the inverse gamma distribution in (sigma2 slot).
## The prior variance of the random walk model which can be a fixed value or two value for the shape (a)
## and rate (b) parameter of the inverse gamma distribution in (sigma2betaW slot).
## The data are specified in (data slot)


Effmodel<- EffFlexi(Eff=c(1.223, 2.513),Effdose=c(25,300),sigma2=c(a=0.1,b=0.1),sigma2betaW=c(a=20,b=50),
