###two examples of using crmPack to run a mDA-CRM design with overdose control
# getwd()
# setwd("C:/Temp/crmpack")
library("crmPack")
source("R/safetywindow.r")
source("R/mDA-CRM-model.r")
source("R/mDA-CRM-design.r")
...
#refDose=56
#non-inforamtive prior for lambdas (number of pieces=npiece_)
