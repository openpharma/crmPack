...
- **Burak Kuersad Guenhan**. Author.

- **Giuseppe Palermo**. Author.
...
- **Dimitris Kontos**. Author.

- **Marlene Schulte-Goebel**. Author.
...
Source:
[`inst/CITATION`](https://github.com/openpharma/crmPack/blob/v2.0.1/inst/CITATION)
