...
#> 
#> attr(,"message")[[1]][[2]]
#> [1] "Probability for target toxicity is 19 % for dose 9 and thus below the required 50 %"
#> 
#> 
#> attr(,"message")[[2]]
...
#> 
#> attr(,"message")[[1]][[2]]
#> [1] "Probability for target toxicity is 26 % for dose 30 and thus below the required 50 %"
#> 
#> 
#> attr(,"message")[[2]]
