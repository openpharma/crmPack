...
#> 1    10 0.03757509 8.808111e-10 0.2324697
#> 2    20 0.07662228 5.000699e-06 0.3292114
#> 3    30 0.13526606 4.777141e-04 0.4317737
#> 4    40 0.22455124 1.698640e-02 0.5380950
#> 5    50 0.35693490 1.309090e-01 0.6726502
#> 6    60 0.51100717 2.033077e-01 0.8469914
#> 7    70 0.62226339 2.317663e-01 0.9593036
#> 8    80 0.69230859 2.554949e-01 0.9917041
#> 9    90 0.73850407 2.836625e-01 0.9980443
#> 10  100 0.77095993 2.969208e-01 0.9993942
fit(samples, ordinal_model, ordinal_data, grade = 2L)
#>    dose     middle        lower     upper
#> 1    10 0.01958754 4.676088e-10 0.1496995
#> 2    20 0.03973961 1.816564e-06 0.1962088
#> 3    30 0.07115961 2.045863e-04 0.2546096
#> 4    40 0.12276743 5.358321e-03 0.3265867
#> 5    50 0.20914990 5.287884e-02 0.4463613
#> 6    60 0.33848781 9.655578e-02 0.6561935
#> 7    70 0.46243237 1.243080e-01 0.8977101
#> 8    80 0.55056846 1.413728e-01 0.9746332
#> 9    90 0.61193936 1.552403e-01 0.9939308
#> 10  100 0.65641036 1.673972e-01 0.9984498
```
...
#>    dose     middle        lower     upper
#> 1    10 0.01798755 4.081900e-10 0.1276538
#> 2    20 0.03688267 1.400734e-06 0.2004795
#> 3    30 0.06410645 1.594413e-04 0.2888179
#> 4    40 0.10178381 1.864623e-03 0.3761141
#> 5    50 0.14778500 5.114458e-03 0.4430690
#> 6    60 0.17251935 6.610945e-03 0.4903974
#> 7    70 0.15983102 6.071507e-03 0.4698607
#> 8    80 0.14174013 3.577338e-03 0.4586513
#> 9    90 0.12656471 1.184151e-03 0.4495504
#> 10  100 0.11454958 3.681314e-04 0.4317883
...
## Environment
    ...
    #> [1] crmPack_2.1.0.9000 ggplot2_4.0.3     
    #> 
    #> loaded via a namespace (and not attached):
    #>  [1] sass_0.4.10          generics_0.1.4       xml2_1.6.0          
    #>  [4] futile.options_1.0.1 lattice_0.22-9       stringi_1.8.7       
    #>  [7] digest_0.6.39        magrittr_2.0.5       evaluate_1.0.5      
    #> [10] grid_4.5.2           RColorBrewer_1.1-3   mvtnorm_1.4-1       
    #> [13] fastmap_1.2.0        jsonlite_2.0.0       backports_1.5.1     
    #> [16] formatR_1.14         gridExtra_2.3.1      viridisLite_0.4.3   
    #> [19] scales_1.4.0         textshaping_1.0.5    jquerylib_0.1.4     
    #> [22] Rdpack_2.6.6         cli_3.6.6            rlang_1.2.0         
    #> [25] rbibutils_2.4.1      futile.logger_1.4.9  parallelly_1.47.0   
    #> [28] withr_3.0.3          cachem_1.1.0         yaml_2.3.12         
    #> [31] otel_0.2.0           parallel_4.5.2       tools_4.5.2         
    #> [34] coda_0.19-4.1        checkmate_2.3.4      dplyr_1.2.1         
    #> [37] lambda.r_1.2.4       kableExtra_1.4.0     vctrs_0.7.3         
    #> [40] R6_2.6.1             lifecycle_1.0.5      stringr_1.6.0       
    #> [43] GenSA_1.1.15         fs_2.1.0             htmlwidgets_1.6.4   
    #> [46] ragg_1.5.2           rjags_4-17           pkgconfig_2.0.3     
    ...
    #> [58] tidyselect_1.2.1     rstudioapi_0.19.0    knitr_1.51          
    #> [61] dichromat_2.0-0.1    farver_2.1.2         htmltools_0.5.9     
    #> [64] labeling_0.4.3       svglite_2.2.2        rmarkdown_2.31      
    #> [67] compiler_4.5.2       S7_0.2.2
