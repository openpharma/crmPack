# Simulate Method for the [`DesignGrouped`](https://docs.crmpack.org/reference/DesignGrouped-class.md) Class
...
#> Doses selected as MTD : mean 16 (16, 16) 
...
#> Mean toxicity risks for the patients on active : mean 11 % (11 %, 11 %) 
#> Doses selected as MTD : mean 16 (16, 16) 
#> True toxicity at doses selected : mean 19 % (19 %, 19 %) 
#> Proportion of trials selecting target MTD: 0 %
#> Dose most often selected as MTD: 16 
#> Observed toxicity rate at dose most often selected: 33 %
#> Fitted toxicity rate at dose most often selected : mean 16 % (16 %, 16 %) 
#> Stop reason triggered:
#>  P(0.2 ≤ prob(DLE | NBD) ≤ 0.35) ≥ 0.5 :  0 %
#>  ≥ 10 patients dosed :  100 %
#>  Stopped because of missing dose :  0 %
