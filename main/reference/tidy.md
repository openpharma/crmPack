...
#> $fit[[1]]
#>        middle        lower     upper
#> 1  0.02777543 0.0001814422 0.1244629
#> 2  0.06084774 0.0022375495 0.1944209
#> 3  0.09031070 0.0073281538 0.2506676
#> 4  0.15848005 0.0361270230 0.3413137
#> 5  0.22161395 0.0777385813 0.4137385
#> 6  0.27991888 0.1270565589 0.4802588
#> 7  0.33302473 0.1592489218 0.5366323
#> 8  0.46081027 0.2411924498 0.6834933
#> 9  0.52347336 0.2750814691 0.7682716
#> 10 0.64456250 0.3533847936 0.8931169
#> 11 0.69363716 0.3803258442 0.9322730
#> 
#> 
#> $stop_report
#> # A tibble: 1 × 1
...
#>  1     1      1     3      2 FALSE FALSE      19    11 <dbl [11]>
#>  2     2      2     5      3 FALSE FALSE      19    11 <dbl [11]>
#>  3     3      3    10      4 FALSE FALSE      19    11 <dbl [11]>
#>  4     4      4    20      6 TRUE  FALSE      19    11 <dbl [11]>
#>  5     5      5    15      5 FALSE FALSE      19    11 <dbl [11]>
#>  6     6      5    15      5 FALSE FALSE      19    11 <dbl [11]>
#>  7     7      5    15      5 FALSE FALSE      19    11 <dbl [11]>
#>  8     8      6    25      7 FALSE FALSE      19    11 <dbl [11]>
#>  9     9      6    25      7 TRUE  FALSE      19    11 <dbl [11]>
#> 10    10      6    25      7 FALSE FALSE      19    11 <dbl [11]>
#> 11    11      7    25      7 FALSE FALSE      19    11 <dbl [11]>
#> 12    12      7    25      7 TRUE  FALSE      19    11 <dbl [11]>
#> 13    13      7    25      7 FALSE FALSE      19    11 <dbl [11]>
#> 14    14      8    25      7 TRUE  FALSE      19    11 <dbl [11]>
#> 15    15      8    25      7 TRUE  FALSE      19    11 <dbl [11]>
#> 16    16      8    25      7 TRUE  FALSE      19    11 <dbl [11]>
#> 17    17      9    15      5 FALSE FALSE      19    11 <dbl [11]>
#> 18    18      9    15      5 FALSE FALSE      19    11 <dbl [11]>
#> 19    19      9    15      5 FALSE FALSE      19    11 <dbl [11]>
#> 
#> 
#> $doses
#> # A tibble: 1 × 1
...
#>  1         1     1  0.420   0.406       1           1        2100     100     1
#>  2         2     1 -1.51    4.19        1           1        2100     100     1
#>  3         3     1 -0.593  14.2         1           1        2100     100     1
#>  4         4     1 -0.168   6.78        1           1        2100     100     1
#>  5         5     1 -0.830   0.456       1           1        2100     100     1
#>  6         6     1 -0.959   3.15        1           1        2100     100     1
#>  7         7     1  0.374   1.69        1           1        2100     100     1
#>  8         8     1 -0.0958  3.57        1           1        2100     100     1
#>  9         9     1  0.953   2.63        1           1        2100     100     1
#> 10        10     1  1.25   10.3         1           1        2100     100     1
#> # ℹ 1,990 more rows
