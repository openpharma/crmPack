...
#> $fit[[1]]
#>        middle        lower     upper
#> 1  0.02053864 4.265933e-06 0.1337666
#> 2  0.04300118 1.477469e-04 0.2147347
#> 3  0.06301901 6.319950e-04 0.2671832
#> 4  0.11107207 5.116981e-03 0.3486667
#> 5  0.15872756 1.992005e-02 0.4045562
#> 6  0.20610358 4.482018e-02 0.4488721
#> 7  0.25260574 7.158305e-02 0.4885573
#> 8  0.38018365 1.732048e-01 0.6313628
#> 9  0.45082956 2.216625e-01 0.7106367
#> 10 0.59586090 3.006964e-01 0.8826881
#> 11 0.65541223 3.438331e-01 0.9259271
#> 
#> 
#> $stop_report
#> # A tibble: 1 × 1
...
#>  1     1      1     3      2 FALSE FALSE      13    11 <dbl [11]>
#>  2     2      2     5      3 FALSE FALSE      13    11 <dbl [11]>
#>  3     3      3    10      4 FALSE FALSE      13    11 <dbl [11]>
#>  4     4      4    20      6 TRUE  FALSE      13    11 <dbl [11]>
#>  5     5      5    20      6 FALSE FALSE      13    11 <dbl [11]>
#>  6     6      5    20      6 FALSE FALSE      13    11 <dbl [11]>
#>  7     7      5    20      6 FALSE FALSE      13    11 <dbl [11]>
#>  8     8      6    25      7 FALSE FALSE      13    11 <dbl [11]>
#>  9     9      6    25      7 TRUE  FALSE      13    11 <dbl [11]>
#> 10    10      6    25      7 FALSE FALSE      13    11 <dbl [11]>
#> 11    11      7    25      7 FALSE FALSE      13    11 <dbl [11]>
#> 12    12      7    25      7 TRUE  FALSE      13    11 <dbl [11]>
#> 13    13      7    25      7 FALSE FALSE      13    11 <dbl [11]>
#> 
#> 
#> $doses
#> # A tibble: 1 × 1
...
#>  1         1     1  0.432   2.58       1           1        2100     100     1
#>  2         2     1 -1.82    2.09       1           1        2100     100     1
#>  3         3     1 -1.25    2.10       1           1        2100     100     1
#>  4         4     1 -0.679   3.04       1           1        2100     100     1
#>  5         5     1  0.151   1.01       1           1        2100     100     1
#>  6         6     1 -1.41    8.07       1           1        2100     100     1
#>  7         7     1 -0.936  15.6        1           1        2100     100     1
#>  8         8     1 -0.874   3.30       1           1        2100     100     1
#>  9         9     1 -1.77    1.62       1           1        2100     100     1
#> 10        10     1 -0.303   4.71       1           1        2100     100     1
#> # ℹ 1,990 more rows
