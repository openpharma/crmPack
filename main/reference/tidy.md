...
#> $fit[[1]]
#>        middle        lower     upper
#> 1  0.04465781 0.0001191833 0.2016758
#> 2  0.08422369 0.0018776089 0.2789568
#> 3  0.11688372 0.0065905840 0.3268283
#> 4  0.18821640 0.0373316705 0.3998596
#> 5  0.25157452 0.0844952825 0.4504365
#> 6  0.30882296 0.1449425139 0.5033998
#> 7  0.36019006 0.1917168310 0.5486790
#> 8  0.48094167 0.2765959232 0.6835776
#> 9  0.53866959 0.2964656862 0.7867169
#> 10 0.64804817 0.3595181715 0.9011095
#> 11 0.69194617 0.3783065833 0.9360873
#> 
#> 
#> $stop_report
#> # A tibble: 1 × 1
...
#>  9     9      7    20      6 FALSE FALSE      17    11 <dbl [11]>        1
#> 10    10      7    20      6 FALSE FALSE      17    11 <dbl [11]>        1
#> 11    11      7    20      6 TRUE  FALSE      17    11 <dbl [11]>        1
#> 12    12      8    20      6 FALSE FALSE      17    11 <dbl [11]>        1
#> 13    13      8    20      6 FALSE FALSE      17    11 <dbl [11]>        1
#> 14    14      8    20      6 FALSE FALSE      17    11 <dbl [11]>        1
#> 15    15      9    25      7 TRUE  FALSE      17    11 <dbl [11]>        1
#> 16    16      9    25      7 TRUE  FALSE      17    11 <dbl [11]>        1
#> 17    17      9    25      7 TRUE  FALSE      17    11 <dbl [11]>        1
#> # ℹ 1 more variable: Backfilled <lgl>
#> 
#> 
#> $doses
...
#>  1         1     1 -0.852  1.73        1           1        2100     100     1
#>  2         2     1 -1.08   0.598       1           1        2100     100     1
#>  3         3     1 -0.157  3.14        1           1        2100     100     1
#>  4         4     1 -0.953  8.04        1           1        2100     100     1
#>  5         5     1  0.954  2.82        1           1        2100     100     1
#>  6         6     1 -1.72   2.35        1           1        2100     100     1
#>  7         7     1 -0.509  1.68        1           1        2100     100     1
#>  8         8     1 -1.11   2.93        1           1        2100     100     1
#>  9         9     1 -0.882  1.14        1           1        2100     100     1
#> 10        10     1 -2.11  36.3         1           1        2100     100     1
#> # ℹ 1,990 more rows
