...
#> Proportions of DLTs in the trials : mean 21 % (21 %, 21 %) 
#> Mean toxicity risks for the patients on active : mean 29 % (29 %, 29 %) 
...
#> Fitted toxicity rate at dose most often selected : mean 24 % (24 %, 24 %) 
#> max_mtd : 165.88 
#> mean_mtd : 31.25 
#> median_mtd : 29.2 
