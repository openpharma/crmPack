...
#>       }
#>     }
#> <bytecode: 0x558f2a6dc328>
#> <environment: 0x558f35038ee8>
#> 
#> Slot "priormodel":
#> function() {
...
#>       alpha1 <- exp(theta[2])
#>     }
#> <bytecode: 0x558f2af98b28>
#> <environment: 0x558f35038cb8>
#> 
#> Slot "modelspecs":
#> function(from_prior) {
...
#>       ms
#>     }
#> <bytecode: 0x558f242870c8>
#> <environment: 0x558f326c00d8>
#> 
#> Slot "init":
#> function() {
#>         c(
