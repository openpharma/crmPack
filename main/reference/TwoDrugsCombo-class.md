...
#>       }
#>     }
#> <bytecode: 0x5588064fe688>
#> <environment: 0x558807c65470>
#> 
#> Slot "priormodel":
#> function() {
...
#>       alpha1 <- exp(theta[2])
#>     }
#> <bytecode: 0x5588069ce348>
#> <environment: 0x558807c656a0>
#> 
#> Slot "modelspecs":
#> function(from_prior) {
...
#>       ms
#>     }
#> <bytecode: 0x55880a07bd60>
#> <environment: 0x55880b8a3028>
#> 
#> Slot "init":
#> function() {
#>         c(
