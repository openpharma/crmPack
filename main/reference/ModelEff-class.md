...
[`DataDual`](https://docs.crmpack.org/reference/DataDual-class.md)), the
dose levels at which these responses are observed (`x` in
[`DataDual`](https://docs.crmpack.org/reference/DataDual-class.md)), all
dose levels considered in the study (`doseGrid` in
[`DataDual`](https://docs.crmpack.org/reference/DataDual-class.md)), and
finally other specifications in
[`DataDual`](https://docs.crmpack.org/reference/DataDual-class.md) class
that can be used to generate prior or posterior modal estimates or
