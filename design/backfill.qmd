...
- Be backwards compatible
  ...
  - Also need to be robust when we meet a `Design` object that does not have a backfill slot
...
- New logical vector in the slot `response` identifying whether each patient had a response or not.
...
- Be backwards compatible
  ...
  - Check again what happens if an old object without the new slots is encountered.
