...
higher for the combination than for the single agent: Then the `refDose` should be
...
a concomitant medication is compared with the single agent, then `refDose`
