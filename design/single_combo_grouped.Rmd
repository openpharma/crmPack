    ...
    function(object,
      ...
      runSim <- function(iterSim) {
        ...
        if (object@mono@startingDose < object@combo@startingDose) {
          stop("combo starting dose cannot be higher than mono starting dose")
        }
        this_mono_dose <- if (object@same_dose) object@combo@startingDose else object@mono@startingDose
        ...
        while (!(stop_mono && stop_combo)) {
          ...
          if (!stop_combo) {
            ...
            if (object@same_dose) {
              if (this_mono_dose < this_combo_dose) stop("combo dose cannot be higher than mono dose")
              this_mono_dose <- this_combo_dose
            }
          }
        }
