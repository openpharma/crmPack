...
test_that("knit_print.StoppingMTDdistribution works correctly", {
  expect_equal(
    ...
    "MTD_DIST: If the mean posterior probability of toxicity at 50% of the next best dose is at least 0.90."
  )
  expect_equal(
    knit_print(
...
test_that("knit_print.StoppingTargetProb works correctly", {
  expect_equal(
    ...
    "TARGET_PROB: If the probability of toxicity at the next best dose is in the range [0.25, 0.60] is at least 0.75."
  )
  expect_equal(
    knit_print(
