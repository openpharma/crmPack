...
---
    ...
    list(theta_drug2_my_combo = c(0, 1), eta_my_combo = 0, mu_mono_intercept_z = 0, 
        tau_mono_intercept = 0.5, mu_mono_slope_z = 0, tau_mono_slope = 0.5)
