...
test_that("knit_print.NextBestNCRMLoss works correctly", {
  ...
  expect_equal(
    knit_print(
      ...
      tox_label = "DLT",
      format_func = kableExtra::kable_minimal,
      asis = FALSE
    ),
    paste0(
      "The dose recommended for the next cohort will be chosen in the ",
      "following way:\n\n-  First, the chance that the probability of ",
      "DLT falls into each of the underdose, target , overdose and ",
      "unacceptable dose ranges is calculated for element of the dose grid.\n",
      ...
      "and summing the result.\n-  Then ineligible doses, and those with a ",
      "probability of being in the overdose or unaccaptable ranges that is ",
      "greater than 0.25, are discarded.\n-  Finally, the dose level with the ",
      "smallest loss is selected as the recommended dose for the next ",
      "cohort.\n\nDLT ranges and loss coefficients are given in the ",
      "following table:\n\n<table class=\" lightable-minimal\" ",
