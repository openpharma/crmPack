...
test_that("reporting labels and logicals are correctly returned using the recursive function in simulate",
          {
            ...
            stopping <- StoppingAll(stopList = list(StoppingAny(stopList = list(stopping1, stopping2), report_label = "label_StoppingAny"), stopping3), report_label  = "label_StoppingAll")
